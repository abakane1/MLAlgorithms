...
def loadCSV():
    ...
    data = np.loadtxt("Cos_Sim_Data.csv", dtype='str', delimiter=',')
    data = data[1:, :]
...
if __name__ == '__main__':
    ...
    test_data = [0.7343859867,-0.7907294817,-0.1003890413,-0.0180661564,1.7125595684,0.8046416553,-0.0961494079,0.7015015279,0.9815600311,0.8700111137,0,0.6202781605
]
